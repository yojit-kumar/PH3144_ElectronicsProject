 ...
 * PC814 "Bench Test"
 *
 * This test checks if the PC814's output circuit is working.
 * We will manually apply 5V to the input to force it to change.
 */

const int ZCD_PIN = 2; // PC814 output (Pin 4)

void setup() {
  Serial.begin(9600);
  Serial.println("--- PC814 Bench Test ---");
  Serial.println("Reading D2. Expecting '1'...");
