...
%	\label{fig:high_voltage}%%% PLEASE DO NOT COPY PASTE %%%
%%% PLEASE DO NOT COPY PASTE %%%
...
%\verb|<Wire.h>|: This is for the I2C communication, allowing us to use the \emph{ADS1115} and the LCD Display.
%
%\verb|<Adafruit_ADS1X15.h>|: It's a high level interface, specifically for the \emph{ADS1115} IC. It makes the process of setting a gain, and reading 16-bit analog values easier.
%
%%% PLEASE DO NOT COPY PASTE %%%


%\verb|<PID_v1.h>|: This is our robust, prebuilt PID algorithm, saving us development time.
%
%\verb|<Emonlib.h>|: This is to directly communicate with the \emph{SCT-013-030} current sensor module, when using the Arduino's inbuilt ADC.
%
%\verb|<ZMPT101B.h>|: This is for direct communicationwith the voltage sensing module,when using the Arduino's inbuilt ADC.
%
...
%Next thing, we initialize is the PID controller. \verb|myPID.SetSampleTime(100)| tells the PID to run every $\SI{100}{\milli\second}$ and the main PID function is \verb|PID(&measurePower, &pidOutput, &setpointPower, Kp, Ki, Kd, REVERSE|.
%A very important part of the code is the interrupt attachment done through: \verb|attachInterrupt(digitalPinToInterrupt(ZCD_PIN), onZeroCross, CHANGE)| It tells the microcontroller to stop whatever it is doing and immediately run the \verb|onZeroCross()|
%
%The main loop is structured to be non-blocking, ensuring that firing logic is never delayed.
%%% PLEASE DO NOT COPY PASTE %%%
